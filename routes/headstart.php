...
// Administration
Route::middleware(config('headstart.middleware'))->namespace('ModernMcGuire\Headstart\Http\Controllers\Admin')->name('admin.')->prefix( config('headstart.prefix'))->group(function() {
	Route::get('/', 'DashboardController@show')->name('dashboard.show');
...
Route::middleware('web')->group(function(){
    Route::get('/{page}', 'ModernMcGuire\Headstart\Http\Controllers\PageController@show')->name('page.show');
});
